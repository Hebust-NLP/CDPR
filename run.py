...
def parse_arguments():
    ...
    parser.add_argument("--data_path", type=str, default='/home/sharing/data', help="The input data dir. Should contain text, video and audio data for the task.")
    ...
    parser.add_argument('--video_feats_path', type=str, default='video_feats.pkl', help="The directory of the video features.")  # raw_video_features_5.pkl swin_roi.pkl

    parser.add_argument('--audio_data_path', type=str, default='audio_data', help="The directory of the audio data.")

    parser.add_argument('--audio_feats_path', type=str, default='audio_feats.pkl', help="The directory of the audio features.")  # audio_imagebind.pkl wavlm_feats.pkl

    parser.add_argument("--text_backbone", type=str, default='bert-large-uncased', help="which backbone to use for text modality") # bert-base-uncased  bert-large-uncased

    parser.add_argument('--method', type=str, default='CDPR', help="which method to use.")

    parser.add_argument("--config_file_name", type=str, default='cdpr_mintrec.py', help = "The name of the config file.")

    parser.add_argument('--seed', type=int, default=0, help="The selected seed.")
    ...
    parser.add_argument('--gpu_id', type=str, default='3', help="The selected GPU id.")
    ...
    parser.add_argument("--output_path", type=str, default='outputs', help="The output directory where all train data will be written.") 

    parser.add_argument("--model_path", type=str, default='models', help="The output directory where the model predictions and checkpoints will be written.") 
